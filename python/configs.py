...
from sim.character_config import CharacterConfig # Updated import
...
CLASS_REGISTRY = {
    "FiendWarlock": FiendWarlock,
    "OpenHandMonk": OpenHandMonk,
    "BerserkerBarbarian": BerserkerBarbarian,
    "ChampionFighter": ChampionFighter,
    "PrecisionTrippingFighter": PrecisionTrippingFighter,
    "AssassinRogue": AssassinRogue,
    "ArcaneTricksterRogue": ArcaneTricksterRogue,
    "DraconicSorcerer": DraconicSorcerer,
    "EvocationWizard": EvocationWizard,
    "DevotionPaladin": DevotionPaladin,
    "GloomstalkerRanger": GloomstalkerRanger,
    "BeastMasterRanger": BeastMasterRanger,
    "Cleric": Cleric,
    "AssaultUnit": AssaultUnit,
    "CMEMulticlass": CMEMulticlass,
    "ValorBard": ValorBard,
}
